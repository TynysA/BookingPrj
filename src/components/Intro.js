  ...
  return (
    <header>
      ...
      <div className="intro container">
        <div className="intro__title">Скидки на всю жизнь? Это Genius.</div>
        <div className="intro__subtitle">
          Путешествуйте с выгодой: получите доступ к скидкам от 10% благодаря
          бесплатному аккаунту Booking.com.
        </div>
        <a href="" className="intro__reg-sing">
  ...
  return (
    <div className="container">
      <nav className="header-1 ">
        <div className="header__logo">Booking.com</div>
        <div className="head main">
          <div className="valuta">
            <select name="select" size="1">
              <option selected value="s1">
                KZT
              </option>
              <option value="s2">RUB</option>
              <option value="s3">USD</option>
            </select>
          </div>
          <form>
            {/* <select
              id="imgCombo"
              onChange={this.doIcon(this.value)}
              className="icon active"
              style="background-image: url(img/eng.png);"
            >
              <option
                style="background-image: url(img/eng.png);"
                className="icon"
                value="eng"
              >
                <p className="lanp">English (US)</p>
              </option>
              <option
                style="background-image: url(img/rus.png);"
                className="icon"
                value="rus"
              >
                <p className="lanp">Русский</p>
              </option>
            </select> */}
          </form>
          <span aria-hidden="true" className="bui-icon bui-icon--large">
            <svg
          ...
          <button className="list">Зарегистрировать свой объект</button>
          <button className="reg">Зарегистрироваться</button>
          <button className="sing">Войти в аккаунт</button>
        </div>
      </nav>
      <nav class="header-2">
        <ul class="bui-tab__nav">
          <li class="bui-tab__item">
            <a class="bui-tab__link bui-tab__link--selected">
              <span class="bui-icon bui-tab__icon bui-icon--medium">
                <svg
              ...
              <span class="bui-tab__text">Жилье</span>
            </a>
          </li>
          <li class="bui-tab__item">
            <a class="bui-tab__link">
              <span class="bui-icon bui-tab__icon bui-icon--medium">
                <svg
                  class="bk-icon -streamline-transport_airplane"
                  height="24"
                  width="24"
                  viewBox="0 0 24 24"
                  role="presentation"
              ...
              <span class="bui-tab__text">Авиабилеты</span>
            </a>
          </li>
          <li class="bui-tab__item">
            <a class="bui-tab__link">
              <span class="bui-icon bui-tab__icon bui-icon--medium">
                <svg
                  class="bk-icon -streamline-transport_car"
                  height="24"
                  width="24"
                  viewBox="0 0 24 24"
                  role="presentation"
              ...
              <span class="bui-tab__text">Аренда машин</span>
            </a>
          </li>
          <li class="bui-tab__item">
            <a class="bui-tab__link">
              <span class="bui-icon bui-tab__icon bui-icon--medium">
                <svg
                  class="bk-icon -streamline-attractions"
                  height="24"
                  width="24"
                  viewBox="0 0 24 24"
                  role="presentation"
              ...
              <span class="bui-tab__text">Варианты досуга</span>
            </a>
          </li>
          <li class="bui-tab__item">
            <a class="bui-tab__link">
              ...
              <span class="bui-tab__text">Такси от/до аэропорта</span>
            </a>
          </li>
        </ul>
      </nav>
